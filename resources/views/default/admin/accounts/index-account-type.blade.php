                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @foreach($accountTypeList as $accountType)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                          <a class="btn btn-success btn-xs mrg" data-original-title="Edit" data-toggle="tooltip" href="{{ route('account-type-edit-form',[$accountType->id]) }}"><i class="fa fa-edit"></i></a>

                                                    <a  class="btn btn-danger btn-xs delete_btn mrg" data-original-title="Delete" data-toggle="tooltip" href="{{ route('account-type-delete',[$accountType->id]) }}"><i class="fa fa-trash-o"></i></a>
                                                </td>

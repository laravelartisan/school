                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @foreach($bookList as $book)
                                            ...
                                            <tr>
                                                <td>{{$sl++}}</td>
                                                <td>
                                                    {{ $book->translate($locale)? $book->bookCategory->book_category_name:$book->translate($defaultLocale)->bookCategory->book_category_name }}
                                                </td>
                                                <td>
                                                    {{ $book->translate($locale)? $book->bookAuthor->author_name:$book->translate($defaultLocale)->bookAuthor->author_name }}
                                                </td>
                                                <td>

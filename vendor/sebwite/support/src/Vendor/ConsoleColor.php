<?php
namespace Sebwite\Support\Vendor;

use Sebwite\Support\Exceptions\InvalidStyleException;
...
class ConsoleColor
{
     ...
     * @param string       $text
     * @return string
     * @throws \Sebwite\Support\Exceptions\InvalidStyleException
        ...
        foreach ($style as $s) {
            if (isset($this->themes[ $s ])) {
                ...
                if ($this->isValidStyle($s)) {
                    ...
                    throw new \Sebwite\Support\Exceptions\InvalidStyleException($s);
                }
            }
        }
